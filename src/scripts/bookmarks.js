...
const generateBookmarkControls = function() {
    ...
    console.log(`ran generateBookmarkControls ${store.addingBookmark}`);
  ...
  const render = function() {
    ...
    // const bookmarkstringString = generateBookmarksString(bookmarks);
  ...
  const handleCreateBookmarkView = function() {
    console.log("ran handleCreateBookmarkView")
